...
class SparkSession:
    ...
    def stop(self) -> None:
        ...
        with SparkSession._lock:
            ...
            SparkConnectClient._uds_path = None
    ...
    def _start_connect_server(master: str, opts: Dict[str, Any]) -> None:
        ...
        if session is None or session._sc._jsc is None:
            ...
            with tempfile.TemporaryDirectory(prefix="local-spark-connect") as path:
                SparkConnectClient._uds_path = path
                os.environ["SPARK_CONNECT_GRPC_SOCKET_PATH"] = path
            try:
                ...
                getattr(
                    SparkContext._jvm,
                    "org.apache.spark.sql.connect.common.config.ConnectCommon",
                ).setConnectSocketPath(SparkConnectClient._uds_path)
                ...
                del os.environ["SPARK_CONNECT_GRPC_SOCKET_PATH"]
        else:
            raise PySparkRuntimeError(
